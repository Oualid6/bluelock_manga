...
function renderPopularChapters() {
  ...
  const latestCh = CHAPTERS.length > 0 ? CHAPTERS[CHAPTERS.length - 1] : { number: 360, title: 'Chapter 360' };
  const popular = [
...
const TRANSLATIONS = {
  EN: {
    ...
    hero_ongoing: "Ongoing · Chapter 360",
    hero_by: "by",
    ...
    cl_subtitle: "360 chapters available · Ongoing",
  ...
  FR: {
    ...
    hero_ongoing: "En cours · Chapitre 360",
    hero_by: "par",
    ...
    cl_subtitle: "360 chapitres disponibles · En cours",
  ...
  ES: {
    ...
    hero_ongoing: "En emisión · Capítulo 360",
    hero_by: "por",
    ...
    cl_subtitle: "360 capítulos disponibles · En emisión",
  ...
  DE: {
    ...
    hero_ongoing: "Laufend · Kapitel 360",
    hero_by: "von",
    ...
    cl_subtitle: "360 Kapitel verfügbar · Laufend",
  ...
  TR: {
    ...
    hero_ongoing: "Devam Ediyor · Bölüm 360",
    hero_by: "yazan",
    ...
    cl_subtitle: "360 bölüm mevcut · Devam ediyor",
  ...
  AR: {
    ...
    cl_subtitle: "360 فصل متوفر · مستمرة",
...
function t(key) {
  ...
  const latestNum = CHAPTERS.length > 0 ? CHAPTERS[CHAPTERS.length - 1].number : 360;
  const totalCount = CHAPTERS.length > 0 ? CHAPTERS.length : 360;
